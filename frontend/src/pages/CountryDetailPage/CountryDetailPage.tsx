...
const missionCountries = [
  ...
  },
  {
    ...
    longDescription: 'I Demokratiska republiken Kongo arbetar vi i konfliktdrabbade områden för att ge humanitär hjälp och stöd till lokala församlingar. Vårt arbete inkluderar nödhjälp, återuppbyggnad av samfund, och stöd till internflyktingar. Vi arbetar också med fredsbyggande initiativ och försoning mellan olika grupper.',
  ...
  },
  {
    ...
    longDescription: 'I Sri Lanka kombinerar vi katastrofhjälp med evangelisation och stöd till lokala pastorer. Efter tsunamin 2004 har vi fortsatt att arbeta med återuppbyggnad och utveckling av lokala samfund. Vi driver program för pastorsutbildning och stöder församlingar i både urbana och rurala områden.',
  ...
  },
  {
    ...
    longDescription: 'I Tanzania driver vi barnhem för föräldralösa barn och ger utbildning till barn i avlägsna byar. Vi arbetar också med att ge medicinsk hjälp och stöd till lokala hälsocentraler. Vårt arbete inkluderar brunnsgrävning, jordbruksutbildning och stöd till kvinnogrupper för ekonomisk utveckling.',
  ...
  },
  {
    ...
    longDescription: 'I Tchad arbetar vi i utmanande ökenområden med evangelisation och vattenprojekt. Vi stöder nomadiska samfund genom att bygga brunnar och ge tillgång till rent vatten. Vårt arbete inkluderar också översättning av Bibeln till lokala språk och utbildning av lokala evangelister.',
    ...
    return (
      <CountryDetailContainer>
        <div style={{ textAlign: 'center', padding: '2rem' }}>
          ...
          <button onClick={() => navigate('/mission')}>Tillbaka till mission</button>
        </div>
      </CountryDetailContainer>
    );
  }
  ...
  const navigateImage = (direction: 'prev' | 'next') => {
    ...
    if (direction === 'prev') {
      setSelectedImageIndex(
        selectedImageIndex === 0 ? country.images.length - 1 : selectedImageIndex - 1
      );
    } else {
      setSelectedImageIndex(
        selectedImageIndex === country.images.length - 1 ? 0 : selectedImageIndex + 1
      );
    }
  };
