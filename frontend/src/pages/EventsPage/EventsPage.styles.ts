...
const cloudDrift = keyframes`
  0% {
    transform: translateX(-110px) translateY(0px) scale(1);
    opacity: 0.11;
  }
  25% {
    transform: translateX(-5px) translateY(-22px) scale(1.12);
    opacity: 0.16;
  }
  50% {
    transform: translateX(55px) translateY(12px) scale(1.06);
    opacity: 0.21;
  }
  75% {
    transform: translateX(25px) translateY(-12px) scale(1.18);
    opacity: 0.14;
  }
  100% {
    transform: translateX(-110px) translateY(0px) scale(1);
...
const cloudFloat = keyframes`
  0% {
    transform: translateX(110px) translateY(0px) scale(0.85);
    opacity: 0.09;
  }
  33% {
    transform: translateX(-25px) translateY(18px) scale(1.22);
    opacity: 0.16;
  }
  66% {
    transform: translateX(-90px) translateY(-28px) scale(1.08);
    opacity: 0.13;
  }
  100% {
    transform: translateX(110px) translateY(0px) scale(0.85);
...
const cloudMorph = keyframes`
  0% {
    border-radius: 55% 45% 75% 55%;
    transform: scale(1) rotate(0deg);
  }
  25% {
    border-radius: 65% 55% 45% 75%;
    transform: scale(1.14) rotate(90deg);
  }
  50% {
    border-radius: 75% 55% 65% 45%;
    transform: scale(0.92) rotate(180deg);
  }
  75% {
    border-radius: 45% 75% 55% 65%;
